...
camera_types = {
    'CAM_FRONT_RIGHT', 'CAM_FRONT', 'CAM_BACK_LEFT', 'CAM_BACK_RIGHT',
...
eval_class_range = dict(bicycle=52, bus=52, car=52, pedestrian=52, truck=52)
eval_pipeline = [
    dict(
        backend_args=None,
        coord_type='LIDAR',
...
load_from = 'work_dirs/centerpoint_short_range/T4Dataset/short_range_pillar_016_convnext_secfpn_4xb16_50m_base/epoch_40.pth'
log_level = 'INFO'
...
model = dict(
    ...
    pts_bbox_head=dict(
        ...
        norm_bbox=True,
        separate_head=dict(
            final_kernel=1, init_bias=-9.2103, type='CustomSeparateHead'),
...
optim_wrapper = dict(
    clip_grad=dict(max_norm=35, norm_type=2),
    dtype='float16',
    loss_scale=dict(growth_interval=400),
...
test_dataloader = dict(
    batch_size=2,
    dataset=dict(
        ann_file='info/kokseang_1_4/t4dataset_base_infos_test.pkl',
        backend_args=None,
        box_type_3d='LiDAR',
        class_names=[
            'car',
...
test_evaluator = dict(
    ann_file='data/t4dataset/info/kokseang_1_4/t4dataset_base_infos_test.pkl',
    backend_args=None,
    class_names=[
        'car',
        'truck',
...
train_dataloader = dict(
    batch_size=16,
    dataset=dict(
        ann_file='info/kokseang_1_4/t4dataset_base_infos_train.pkl',
        backend_args=None,
        box_type_3d='LiDAR',
        class_names=[
            'car',
...
val_dataloader = dict(
    batch_size=2,
    dataset=dict(
        ann_file='info/kokseang_1_4/t4dataset_base_infos_val.pkl',
        backend_args=None,
        box_type_3d='LiDAR',
        class_names=[
            'car',
    ...
    sampler=dict(shuffle=False, type='DefaultSampler'))
val_evaluator = dict(
    ann_file='data/t4dataset/info/kokseang_1_4/t4dataset_base_infos_val.pkl',
    backend_args=None,
    class_names=[
        'car',
        'truck',
...
work_dir = 'work_dirs/centerpoint_short_range/T4Dataset/short_range_pillar_016_convnext_secfpn_4xb16_50m_base/'
