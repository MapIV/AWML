...
info_train_file_name = 'nuscenes_infos_train.pkl'
info_test_file_name = 'nuscenes_infos_val.pkl'
info_val_file_name = 'nuscenes_infos_val.pkl'
input_modality = dict(
    use_camera=False,
    use_external=False,
    use_lidar=True,
...
load_from = 'checkpoints/AWML_centerpoint_v1.4_best_epoch_49.pth'
log_level = 'INFO'
