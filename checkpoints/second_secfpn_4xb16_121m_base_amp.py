...
custom_imports = dict(
    ...
    imports=[
        ...
        'autoware_ml.hooks',
        'autoware_ml.backends.mlflowbackend',
    ])
...
load_from = 'work_dirs/centerpoint_1_6/T4Dataset/second_secfpn_4xb16_121m_base_amp/best_NuScenes metric_T4Metric_mAP_epoch_48.pth'
log_level = 'INFO'
...
test_dataloader = dict(
    batch_size=2,
    dataset=dict(
        ann_file='info/kokseang_1_6/t4dataset_base_infos_test.pkl',
        backend_args=None,
        box_type_3d='LiDAR',
        class_names=[
            'car',
...
test_evaluator = dict(
    ann_file='data/t4dataset/info/kokseang_1_6/t4dataset_base_infos_test.pkl',
    backend_args=None,
    class_names=[
        'car',
        'truck',
...
train_dataloader = dict(
    batch_size=16,
    dataset=dict(
        ann_file='info/kokseang_1_6/t4dataset_base_infos_train.pkl',
        backend_args=None,
        box_type_3d='LiDAR',
        class_names=[
            'car',
...
val_dataloader = dict(
    batch_size=2,
    dataset=dict(
        ann_file='info/kokseang_1_6/t4dataset_base_infos_val.pkl',
        backend_args=None,
        box_type_3d='LiDAR',
        class_names=[
            'car',
    ...
    sampler=dict(shuffle=False, type='DefaultSampler'))
val_evaluator = dict(
    ann_file='data/t4dataset/info/kokseang_1_6/t4dataset_base_infos_val.pkl',
    backend_args=None,
    class_names=[
        'car',
        'truck',
...
work_dir = 'work_dirs/centerpoint_1_6/T4Dataset/second_secfpn_4xb16_121m_base_amp/'
